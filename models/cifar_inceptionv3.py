...
class Model(base.Model):
    ...
    def __init__(self, initializer, num_classes=1000, aux_logits=False, transform_input=False,
    ...
    def is_valid_model_name(model_name):
        return model_name == 'cifar_inceptionv3'

    @staticmethod
    def get_model_from_name(model_name, initializer, outputs):

        return Model(initializer=initializer, num_classes=outputs)
    ...
    def default_hparams():
        model_hparams = hparams.ModelHparams(
            model_name='cifar_inceptionv3',
            model_init='kaiming_normal',
            batchnorm_init='uniform'
        )

        dataset_hparams = hparams.DatasetHparams(
            dataset_name='cifar10_299',
            batch_size=64
        )
