...
from models import cifar_resnet, cifar_vgg, mnist_lenet, imagenet_resnet, squeezenet_cifar, densenet, charcnn, tinyimagenet_vgg, mnist_lenet5, cifar_inceptionv3
...
registered_models = [mnist_lenet.Model, cifar_resnet.Model, cifar_vgg.Model, 
                    ...
                    charcnn.Model, tinyimagenet_vgg.Model, mnist_lenet5.Model, cifar_inceptionv3.Model]
